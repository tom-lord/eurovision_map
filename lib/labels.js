...
function country_score(to_country)
{
    ...
    /////////////////////////////////////////////////////////////////////////
    // TODO: Remove this temporary bodge
    var force_config = {};
    if( CONFIG.voters == 'difference' )
    {
        force_config['voters'] = 'combined';
    }
    /////////////////////////////////////////////////////////////////////////
    ...
    for(var from_country in from_country_rankings())
    {
        ...
        {
            score += VOTING.apply( from_country_rankings(force_config)[from_country][to_country] );
        }
    }
    return score;
}
...
function country_position(code)
{
    ...
    jQuery.each(countries_entered(), function(idx) 
    {
